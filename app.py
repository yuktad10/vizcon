...
def load_metrics():
    ...
    # Streamlit Cloud: files in Data/ folder relative to app.py
    data_path = Path(__file__).parent / "Data" / "metrics-and-summary.csv"
    if not data_path.exists():
        # Try same directory
        data_path = Path(__file__).parent / "metrics-and-summary.csv"
    if not data_path.exists():
        # Try current working directory
        data_path = Path("Data") / "metrics-and-summary.csv"
